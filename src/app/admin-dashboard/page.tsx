...
import { Eye, Info, ChevronRight, Download, CreditCard, ArrowRight } from 'lucide-react';
                ...
                <div className={styles.banner}>
                    <div className={styles.bannerContent}>
                        <div className={styles.bannerText}>
                            <span className={styles.bannerLabel}>DO BRASIL PARA O MUNDO</span>
                            <h1>Seu produto digital sem limite de fronteiras</h1>
                            <div className={styles.brandBadge}>
                                <span className={styles.greenText}>greenn</span>
                            </div>
                            <p>Chegou a Greenn Internacional. Venda em outros países e receba em reais, sem complicação.</p>
